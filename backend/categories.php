                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                while($categories = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                    // category_id, category_name, category_total_post, category_status, created_by
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php 
                                                               ...
                                                               <?php } else { ?>
                                                                    <a href="../category.php?category_id=<?php echo $category_id; ?>&category_name=<?php echo $category_name; ?>" target="_blank">
                                                                        <?php echo $category_name; ?>
                                                                    </a>
                                                              <?php }
                                                            ?>
